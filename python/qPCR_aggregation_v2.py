...
def aggregate(folder_name):
    ...
    #     # if fnmatch.fnmatch(str(subdirectory), 'Batch*'):
    #     if fnmatch.fnmatch(str(subdirectory).split("\\")[-1], 'Batch*'):
    #         # print(subdirectory)
    #         p = Path(cwd + "/" + str(subdirectory))
    ...
    for row_number in range(1, row_counter):
        ...
        qc_summary.append(row_data)
    print(json.dumps(qc_summary))
